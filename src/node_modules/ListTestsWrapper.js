...
//
    ...
    let global = useSelector((store) => {return store.currentTest});
console.log('ListTestsWrapper:  global=',global);

const dispatch = useDispatch();   

dispatch({type: 'SET_TESTS', setStateTests: "full", stateEdit: false});

console.log('ListTestsWrapper:  global.count_questions_test=',global.count_questions_test);
